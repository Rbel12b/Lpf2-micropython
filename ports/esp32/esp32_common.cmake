...
file(GLOB MAIN_SOURCES_CXX "${CMAKE_CURRENT_LIST_DIR}/*.cpp")
file(GLOB MAIN_SOURCES_C "${CMAKE_CURRENT_LIST_DIR}/*.c")
...
list(APPEND MICROPY_SOURCE_PORT ${CMAKE_BINARY_DIR}/pins.c ${MAIN_SOURCES_CXX} ${MAIN_SOURCES_C} ${MAIN_LIB_SOURCES})
